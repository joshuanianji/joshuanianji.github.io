...
var author$project$Molecule$MoleculeParser$HydrateAtom = function (a) {
	return {$: 'HydrateAtom', a: a};
};
var author$project$Molecule$MoleculeParser$PolyAtom = F2(
	function (a, b) {
		return {$: 'PolyAtom', a: a, b: b};
	});
var author$project$Molecule$MoleculeParser$SingleAtom = F2(
	function (a, b) {
		return {$: 'SingleAtom', a: a, b: b};
	});
var author$project$Molecule$MoleculeParser$Unknown = function (a) {
	return {$: 'Unknown', a: a};
};
...
var author$project$Molecule$MoleculeParser$checkAtomName = function (atomParserData) {
	if (atomParserData.$ === 'SingleAtom') {
		var name = atomParserData.a;
		var amount = atomParserData.b;
...
var author$project$Molecule$MoleculeParser$integer = A2(
...
var author$project$Molecule$MoleculeParser$oneOrMoreSpaces = A2(
...
var author$project$Molecule$MoleculeParser$moleculeHelper = function (molecule) {
	...
	return A2(
		...
		author$project$Molecule$MoleculeParser$cyclic$atomParser());
};
function author$project$Molecule$MoleculeParser$cyclic$atomParser() {
	return elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				...
				A2(
					elm$parser$Parser$ignorer,
					elm$parser$Parser$succeed(author$project$Molecule$MoleculeParser$HydrateAtom),
					author$project$Molecule$MoleculeParser$oneOrMoreSpaces),
				elm$parser$Parser$oneOf(
					_List_fromArray(
						[
							A2(
							elm$parser$Parser$ignorer,
							author$project$Molecule$MoleculeParser$integer,
				...
				A2(
				elm$parser$Parser$andThen,
				author$project$Molecule$MoleculeParser$checkAtomName,
				A2(
					elm$parser$Parser$keeper,
					A2(
						elm$parser$Parser$keeper,
						elm$parser$Parser$succeed(author$project$Molecule$MoleculeParser$SingleAtom),
				...
				A2(
					...
					A2(
						...
						A2(
							elm$parser$Parser$ignorer,
							elm$parser$Parser$succeed(author$project$Molecule$MoleculeParser$PolyAtom),
					...
					A2(
						...
						A2(
							elm$parser$Parser$ignorer,
							author$project$Molecule$MoleculeParser$cyclic$moleculeParser(),
							elm$parser$Parser$spaces),
						elm$parser$Parser$symbol(')'))),
				elm$parser$Parser$oneOf(
					_List_fromArray(
				...
				A2(
				elm$parser$Parser$map,
				author$project$Molecule$MoleculeParser$Unknown,
				elm$parser$Parser$getChompedString(
					A2(
						elm$parser$Parser$ignorer,
...
function author$project$Molecule$MoleculeParser$cyclic$moleculeParser() {
	return A2(elm$parser$Parser$loop, _List_Nil, author$project$Molecule$MoleculeParser$moleculeHelper);
}
try {
	var author$project$Molecule$MoleculeParser$atomParser = author$project$Molecule$MoleculeParser$cyclic$atomParser();
	author$project$Molecule$MoleculeParser$cyclic$atomParser = function () {
		return author$project$Molecule$MoleculeParser$atomParser;
	};
	var author$project$Molecule$MoleculeParser$moleculeParser = author$project$Molecule$MoleculeParser$cyclic$moleculeParser();
	author$project$Molecule$MoleculeParser$cyclic$moleculeParser = function () {
		return author$project$Molecule$MoleculeParser$moleculeParser;
	};
} catch ($) {
throw 'Some top-level definitions from `Molecule.MoleculeParser` are causing infinite recursion:\n\n  ┌─────┐\n  │    atomParser\n  │     ↓\n  │    moleculeParser\n  │     ↓\n  │    moleculeHelper\n  └─────┘\n\nThese errors are very tricky, so read https://elm-lang.org/0.19.0/halting-problem to learn how to fix it!';}
var author$project$Molecule$Molecule$BadMolecule = function (a) {
	return {$: 'BadMolecule', a: a};
};
var author$project$Atom$Atom$Fail = function (a) {
	return {$: 'Fail', a: a};
};
var author$project$Atom$Atom$Success = function (a) {
	return {$: 'Success', a: a};
};
...
var author$project$Atom$Atom$Atom = function (name) {
...
var author$project$Atom$Atom$PhaseChanges = F2(
	function (melt, boil) {
...
var author$project$DataBase$DataParser$phaseChangeDecoder = A3(
	...
	A3(
		...
		'melt',
		elm$json$Json$Decode$nullable(elm$json$Json$Decode$float),
		elm$json$Json$Decode$succeed(author$project$Atom$Atom$PhaseChanges)));
var author$project$Atom$Atom$Actinide = {$: 'Actinide'};
var author$project$Atom$Atom$Alkali = {$: 'Alkali'};
var author$project$Atom$Atom$AlkalineEarth = {$: 'AlkalineEarth'};
var author$project$Atom$Atom$Halogen = {$: 'Halogen'};
var author$project$Atom$Atom$Hydrogen = {$: 'Hydrogen'};
var author$project$Atom$Atom$Lanthanide = {$: 'Lanthanide'};
var author$project$Atom$Atom$Metalloid = {$: 'Metalloid'};
var author$project$Atom$Atom$NobleGas = {$: 'NobleGas'};
var author$project$Atom$Atom$NonMetal = {$: 'NonMetal'};
var author$project$Atom$Atom$PostTransitionMetal = {$: 'PostTransitionMetal'};
var author$project$Atom$Atom$TransitionMetal = {$: 'TransitionMetal'};
var author$project$Atom$Atom$UnknownSection = {$: 'UnknownSection'};
...
var author$project$DataBase$DataParser$sectionDecoder = A2(
	...
	function (str) {
		switch (str) {
			case 'hydrogen':
				return elm$json$Json$Decode$succeed(author$project$Atom$Atom$Hydrogen);
			case 'alkali metal':
				return elm$json$Json$Decode$succeed(author$project$Atom$Atom$Alkali);
			case 'alkaline earth metal':
				return elm$json$Json$Decode$succeed(author$project$Atom$Atom$AlkalineEarth);
			case 'transition metal':
				return elm$json$Json$Decode$succeed(author$project$Atom$Atom$TransitionMetal);
			case 'metalloid':
				return elm$json$Json$Decode$succeed(author$project$Atom$Atom$Metalloid);
			case 'post-transition metal':
				return elm$json$Json$Decode$succeed(author$project$Atom$Atom$PostTransitionMetal);
			case 'diatomic nonmetal':
				return elm$json$Json$Decode$succeed(author$project$Atom$Atom$NonMetal);
			case 'polyatomic nonmetal':
				return elm$json$Json$Decode$succeed(author$project$Atom$Atom$NonMetal);
			case 'halogen':
				return elm$json$Json$Decode$succeed(author$project$Atom$Atom$Halogen);
			case 'noble gas':
				return elm$json$Json$Decode$succeed(author$project$Atom$Atom$NobleGas);
			case 'lanthanide':
				return elm$json$Json$Decode$succeed(author$project$Atom$Atom$Lanthanide);
			case 'actinide':
				return elm$json$Json$Decode$succeed(author$project$Atom$Atom$Actinide);
			default:
				return elm$json$Json$Decode$succeed(author$project$Atom$Atom$UnknownSection);
		}
	},
	elm$json$Json$Decode$string);
var author$project$Atom$Atom$Gas = {$: 'Gas'};
var author$project$Atom$Atom$Liquid = {$: 'Liquid'};
var author$project$Atom$Atom$Solid = {$: 'Solid'};
var author$project$Atom$Atom$UnknownState = {$: 'UnknownState'};
var author$project$DataBase$DataParser$stateDecoder = A2(
	elm$json$Json$Decode$andThen,
	function (str) {
		switch (str) {
			case 'Gas':
				return elm$json$Json$Decode$succeed(author$project$Atom$Atom$Gas);
			case 'Solid':
				return elm$json$Json$Decode$succeed(author$project$Atom$Atom$Solid);
			case 'Liquid':
				return elm$json$Json$Decode$succeed(author$project$Atom$Atom$Liquid);
			default:
				return elm$json$Json$Decode$succeed(author$project$Atom$Atom$UnknownState);
		}
	},
	elm$json$Json$Decode$string);
...
var author$project$DataBase$DataParser$weightDecoder = function () {
	...
	var atomWeightResult = elm$json$Json$Decode$decodeString(elm$json$Json$Decode$float);
	return A2(
		elm$json$Json$Decode$andThen,
													...
													A3(
														...
														A3(
															...
															A3(
																...
																'name',
																elm$json$Json$Decode$string,
																elm$json$Json$Decode$succeed(author$project$Atom$Atom$Atom)))))))))))))));
	},
...
var author$project$DataBase$DataParser$retrieveAtom = function (symbol) {
	...
	if (filteredAtomList.b && (!filteredAtomList.b.b)) {
		...
		return author$project$Atom$Atom$Success(a);
	} else {
		return author$project$Atom$Atom$Fail(symbol);
	}
};
var author$project$Molecule$Molecule$GoodMolecule = function (a) {
	return {$: 'GoodMolecule', a: a};
};
var author$project$Molecule$Molecule$Hydrate = function (a) {
	return {$: 'Hydrate', a: a};
};
var author$project$Molecule$Molecule$Mono = F2(
	function (a, b) {
		return {$: 'Mono', a: a, b: b};
	});
var author$project$Molecule$Molecule$Poly = F2(
	function (a, b) {
		return {$: 'Poly', a: a, b: b};
	});
...
var author$project$Molecule$MoleculeParser$collapseMaybeList = function (list) {
	return elm_community$maybe_extra$Maybe$Extra$combine(list);
};
...
var author$project$Molecule$MoleculeParser$parserDataToCompound = F2(
	function (atomParserData, amount) {
		var compoundList = author$project$Molecule$MoleculeParser$collapseMaybeList(
			A2(elm$core$List$map, author$project$Molecule$MoleculeParser$parserDatumToCompound, atomParserData));
		if (compoundList.$ === 'Nothing') {
			return author$project$Molecule$Molecule$BadMolecule(
				_List_fromArray(
					[
						A3(
			...
			return _Utils_eq(list, _List_Nil) ? author$project$Molecule$Molecule$BadMolecule(
				_List_fromArray(
					[
						A3(
						elm$parser$Parser$DeadEnd,
					...
					])) : author$project$Molecule$Molecule$GoodMolecule(
				A2(author$project$Molecule$Molecule$Poly, list, amount));
		}
	});
var author$project$Molecule$MoleculeParser$parserDatumToCompound = function (data) {
	switch (data.$) {
		case 'SingleAtom':
			var symbol = data.a;
			var amount = data.b;
			return elm$core$Maybe$Just(
				A2(
					author$project$Molecule$Molecule$Mono,
					author$project$DataBase$DataParser$retrieveAtom(symbol),
					amount));
		case 'PolyAtom':
			var atoms = data.a;
			var amount = data.b;
			var _n1 = A2(author$project$Molecule$MoleculeParser$parserDataToCompound, atoms, amount);
			if (_n1.$ === 'GoodMolecule') {
				var molecule = _n1.a;
		...
		case 'HydrateAtom':
			var amount = data.a;
			return elm$core$Maybe$Just(
				author$project$Molecule$Molecule$Hydrate(amount));
		default:
			var string = data.a;
			return elm$core$Maybe$Nothing;
	}
};
var author$project$Molecule$MoleculeParser$removeResult = function (test) {
	if (test.$ === 'Ok') {
		var result = test.a;
		return A2(author$project$Molecule$MoleculeParser$parserDataToCompound, result, 1);
	} else {
		var error = test.a;
		return author$project$Molecule$Molecule$BadMolecule(error);
	}
};
...
var author$project$Molecule$MoleculeParser$stringToMolecule = function (string) {
	return author$project$Molecule$MoleculeParser$removeResult(
		A2(elm$parser$Parser$run, author$project$Molecule$MoleculeParser$moleculeParser, string));
};
var author$project$Main$moleculeDataInit = {
	inputMolecule: author$project$Molecule$MoleculeParser$stringToMolecule('CuSO4 5H2O'),
	inputMoleculeString: 'CuSO4 5H2O',
	selectedAtoms: _List_Nil
};
var author$project$Model$TableAndParserView = {$: 'TableAndParserView'};
var author$project$Main$initModel = {directory: author$project$Model$TableAndParserView, moleculeData: author$project$Main$moleculeDataInit, selectedAtom: elm$core$Maybe$Nothing, viewport: elm$core$Maybe$Nothing};
...
var author$project$Msg$BrowserResized = F2(
	function (a, b) {
...
var author$project$Subscriptions$subscriptions = function (model) {
	return elm$browser$Browser$Events$onResize(author$project$Msg$BrowserResized);
};
var author$project$Model$ScreenSize = F2(
	function (height, width) {
		return {height: height, width: width};
	});
var author$project$Model$ZoomAtomView = {$: 'ZoomAtomView'};
...
var author$project$Molecule$MoleculeParser$toAtomList = function (maybeMolecule) {
		...
		switch (msg.$) {
					...
					_Utils_update(
						model,
						{
							viewport: elm$core$Maybe$Just(
								A2(author$project$Model$ScreenSize, viewport.viewport.height, viewport.viewport.width))
						}),
			...
			case 'BrowserResized':
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							viewport: elm$core$Maybe$Just(
								A2(author$project$Model$ScreenSize, height, width))
						}),
					elm$core$Platform$Cmd$none);
			case 'ZoomAtom':
				var atom = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							directory: author$project$Model$ZoomAtomView,
			...
			case 'UnZoomAtom':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{directory: author$project$Model$TableAndParserView, selectedAtom: elm$core$Maybe$Nothing}),
					elm$core$Platform$Cmd$none);
					...
					_Utils_update(
						model,
						{
							moleculeData: _Utils_update(
								c,
								{
									inputMolecule: author$project$Molecule$MoleculeParser$stringToMolecule(text),
									inputMoleculeString: text,
									selectedAtoms: author$project$Molecule$MoleculeParser$toAtomList(
										author$project$Molecule$MoleculeParser$stringToMolecule(text))
								})
						}),
					elm$core$Platform$Cmd$none);
		}
...
var author$project$DataBase$DataParser$errorAtom = author$project$Atom$Atom$Atom('Error')('Err')(author$project$Atom$Atom$Gas)(author$project$Atom$Atom$TransitionMetal)(1)(1)(1)('69.6969')(
	_List_fromArray(
		[6, 9]))('https://en.wikipedia.org/wiki/PewDiePie_vs_T-Series')('ree')('Joshua Ji')('Penis Parker')(
	A2(
		author$project$Atom$Atom$PhaseChanges,
		elm$core$Maybe$Just(2000),
		elm$core$Maybe$Just(4000)));
...
var author$project$DetailedElementView$phaseChanges = function (atom) {
	var thisAtom = atom.phaseChanges;
	return A2(
						...
						mdgriffith$elm_ui$Element$text(
							A2(
								...
								A2(
									...
									A2(elm$core$Maybe$map, elm$core$String$fromFloat, thisAtom.melt)))))
					])),
				A2(
				mdgriffith$elm_ui$Element$paragraph,
				_List_Nil,
						...
						mdgriffith$elm_ui$Element$text(
							A2(
								...
								A2(
									...
									A2(elm$core$Maybe$map, elm$core$String$fromFloat, thisAtom.boil)))))
					]))
			]));
};
...
var author$project$DetailedElementView$extraInfo = function (atom) {
	return A2(
		mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				author$project$DetailedElementView$phaseChanges(atom),
				A2(
				mdgriffith$elm_ui$Element$paragraph,
				_List_fromArray(
					[mdgriffith$elm_ui$Element$Font$light]),
...
var author$project$Subscriptions$Width = {$: 'Width'};
var author$project$Subscriptions$screenDimension = F2(
	function (viewPortArg, model) {
		var _n0 = model.viewport;
		if (_n0.$ === 'Just') {
			var viewport = _n0.a;
			var viewportWidth = viewport.width;
			var viewportHeight = viewport.height;
			if (viewPortArg.$ === 'Height') {
...
var author$project$TableAndParser$DetailedAtomBox$atomName = function (atom) {
	return A2(
		mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
...
var author$project$TableAndParser$DetailedAtomBox$atomNum = function (atom) {
	return A2(
		mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
...
var author$project$TableAndParser$DetailedAtomBox$atomShells = function (atom) {
	return A2(
		mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
...
var author$project$TableAndParser$DetailedAtomBox$atomSymbol = function (atom) {
	return A2(
		mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
...
var author$project$TableAndParser$DetailedAtomBox$atomWeight = function (atom) {
	return A2(
		mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
...
var author$project$TableAndParser$DetailedAtomBox$atomBoxZoom = function (atom) {
	return A2(
		mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
				...
				author$project$TableAndParser$DetailedAtomBox$atomShells(atom))
			]),
		_List_fromArray(
			[
				author$project$TableAndParser$DetailedAtomBox$atomNum(atom),
				author$project$TableAndParser$DetailedAtomBox$atomSymbol(atom),
				author$project$TableAndParser$DetailedAtomBox$atomName(atom),
				author$project$TableAndParser$DetailedAtomBox$atomWeight(atom)
			]));
};
...
var author$project$DetailedElementView$atomZoomContent = function (model) {
	var screenWidth = A2(author$project$Subscriptions$screenDimension, author$project$Subscriptions$Width, model);
	var atom = function () {
		var _n0 = model.selectedAtom;
		if (_n0.$ === 'Just') {
			var a = _n0.a;
			return a;
		} else {
			return author$project$DataBase$DataParser$errorAtom;
		}
	}();
	return A2(
		mdgriffith$elm_ui$Element$el,
			...
			_List_fromArray(
				[
					...
					mdgriffith$elm_ui$Element$px(
						elm$core$Basics$round((screenWidth * 3) / 4)))
				]),
			_List_fromArray(
				[
					author$project$TableAndParser$DetailedAtomBox$atomBoxZoom(atom),
					author$project$DetailedElementView$extraInfo(atom)
				])));
};
var author$project$Msg$UnZoomAtom = {$: 'UnZoomAtom'};
...
var author$project$DetailedElementView$closeButton = A2(
	mdgriffith$elm_ui$Element$el,
	_List_fromArray(
		[
			mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$shrink),
			...
			mdgriffith$elm_ui$Element$Events$onClick(author$project$Msg$UnZoomAtom),
			mdgriffith$elm_ui$Element$pointer,
			mdgriffith$elm_ui$Element$Font$center
		]),
	mdgriffith$elm_ui$Element$text('×'));
var author$project$DetailedElementView$atomZoomView = function (model) {
	return A2(
		mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				author$project$DetailedElementView$closeButton,
				author$project$DetailedElementView$atomZoomContent(model)
			]));
};
var author$project$Atom$Atom$PTableAtom = function (a) {
	return {$: 'PTableAtom', a: a};
};
var author$project$Atom$Atom$PTablePlaceholder = function (a) {
	return {$: 'PTablePlaceholder', a: a};
};
var author$project$DataBase$DataParser$placeholders = _List_fromArray(
	[
		author$project$Atom$Atom$PTablePlaceholder(
		{name: 'Lanthanide', section: author$project$Atom$Atom$Lanthanide, xpos: 3}),
		author$project$Atom$Atom$PTablePlaceholder(
		{name: 'Actinide', section: author$project$Atom$Atom$Actinide, xpos: 3})
	]);
var author$project$DataBase$DataParser$pTableAtomList = _Utils_ap(
	A2(
		elm$core$List$map,
		function (atom) {
			return author$project$Atom$Atom$PTableAtom(atom);
		},
		author$project$DataBase$DataParser$atomList),
	author$project$DataBase$DataParser$placeholders);
var author$project$TableAndParser$PeriodicTable$getfBlockElements = function (pTableAtomList) {
	return A2(
		elm$core$List$filter,
		function (pTableAtom) {
			if (pTableAtom.$ === 'PTableAtom') {
				var atom = pTableAtom.a;
				return _Utils_eq(atom.section, author$project$Atom$Atom$Lanthanide) || _Utils_eq(atom.section, author$project$Atom$Atom$Actinide);
			} else {
				return false;
			}
		},
...
var author$project$TableAndParser$PeriodicTable$filterAtomGroup = F2(
...
var author$project$TableAndParser$PeriodicTable$tableGroup = function (elementList) {
	return A2(
		mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
...
var author$project$Atom$AtomBox$atomMolarMass = function (atom) {
	return A2(
		mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
...
var author$project$Atom$AtomBox$atomNum = function (atom) {
	return A2(
		mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
...
var author$project$Atom$AtomBox$atomSymbol = function (atom) {
	return A2(
		mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
...
var author$project$Atom$AtomBox$borderWidths = {bottom: 2, left: 0, right: 0, top: 0};
...
var author$project$Msg$ZoomAtom = function (a) {
	return {$: 'ZoomAtom', a: a};
};
...
var author$project$Atom$AtomBox$atomBox = F2(
	function (model, atom) {
		var attributes = A2(
			elm$core$List$cons,
			...
			_List_fromArray(
				[
					...
					mdgriffith$elm_ui$Element$padding(10),
					mdgriffith$elm_ui$Element$Font$color(author$project$Colours$fontColour),
					mdgriffith$elm_ui$Element$Border$widthEach(author$project$Atom$AtomBox$borderWidths),
					mdgriffith$elm_ui$Element$Border$color(
					author$project$Colours$sectionColour(atom.section)),
					mdgriffith$elm_ui$Element$pointer,
					mdgriffith$elm_ui$Element$Events$onClick(
					author$project$Msg$ZoomAtom(atom)),
		...
		return A2(
			...
			_List_fromArray(
				[
					author$project$Atom$AtomBox$atomNum(atom),
					author$project$Atom$AtomBox$atomSymbol(atom),
					author$project$Atom$AtomBox$atomMolarMass(atom)
				]));
	});
...
var author$project$Atom$AtomBox$placeholderBox = function (placeholder) {
	var groupSpan = function () {
		var _n0 = placeholder.section;
		switch (_n0.$) {
			case 'Lanthanide':
				return '57-71';
			case 'Actinide':
...
var author$project$Atom$AtomBox$pTableBox = F2(
	function (model, pTableAtom) {
		if (pTableAtom.$ === 'PTableAtom') {
			var atom = pTableAtom.a;
			return A2(author$project$Atom$AtomBox$atomBox, model, atom);
		} else {
			var placeholder = pTableAtom.a;
			return author$project$Atom$AtomBox$placeholderBox(placeholder);
		}
	});
var author$project$TableAndParser$PeriodicTable$toBoxes = F2(
	function (model, pTableAtoms) {
		return A2(
			elm$core$List$map,
			author$project$Atom$AtomBox$pTableBox(model),
			pTableAtoms);
	});
var author$project$TableAndParser$PeriodicTable$styleTableGroups = F3(
	function (model, pTableAtomList, group) {
		return author$project$TableAndParser$PeriodicTable$tableGroup(
			A2(
				author$project$TableAndParser$PeriodicTable$toBoxes,
				model,
				A2(author$project$TableAndParser$PeriodicTable$filterAtomGroup, pTableAtomList, group)));
	});
var author$project$TableAndParser$PeriodicTable$lowerPeriodicTable = function (model) {
	return A2(
		mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
		...
		A2(
			elm$core$List$map,
			A2(
				author$project$TableAndParser$PeriodicTable$styleTableGroups,
				model,
				author$project$TableAndParser$PeriodicTable$getfBlockElements(author$project$DataBase$DataParser$pTableAtomList)),
			A2(elm$core$List$range, 3, 17)));
};
var author$project$TableAndParser$PeriodicTable$withoutfBlockElements = function (pTableAtomList) {
	return A2(
		elm$core$List$filter,
		function (pTableAtom) {
			if (pTableAtom.$ === 'PTableAtom') {
...
var author$project$TableAndParser$PeriodicTable$upperPeriodicTable = function (model) {
	return A2(
		mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
		...
		A2(
			...
			A2(
				author$project$TableAndParser$PeriodicTable$styleTableGroups,
				model,
				author$project$TableAndParser$PeriodicTable$withoutfBlockElements(author$project$DataBase$DataParser$pTableAtomList)),
			A2(elm$core$List$range, 1, 18)));
};
var author$project$TableAndParser$PeriodicTable$periodicTable = function (model) {
	return A2(
		mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				author$project$TableAndParser$PeriodicTable$upperPeriodicTable(model),
				author$project$TableAndParser$PeriodicTable$lowerPeriodicTable(model)
			]));
};
var author$project$Colours$appBackgroundGray = A3(mdgriffith$elm_ui$Element$rgb255, 51, 51, 61);
var author$project$Msg$UpdateMoleculeParser = function (a) {
	return {$: 'UpdateMoleculeParser', a: a};
};
var author$project$TableAndParserView$inputBorder = mdgriffith$elm_ui$Element$Border$widthEach(
...
var author$project$TableAndParserView$compoundInput = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				...
				author$project$TableAndParserView$inputBorder,
			...
			]),
		{
			...
			onChange: author$project$Msg$UpdateMoleculeParser,
...
var author$project$Molecule$MoleculeDisplay$moleculeTextHtml = function (molecule) {
	switch (molecule.$) {
		case 'Mono':
			var maybeAtom = molecule.a;
			var quantity = molecule.b;
			if (maybeAtom.$ === 'Success') {
				var atom = maybeAtom.a;
		...
		case 'Poly':
			var atomList = molecule.a;
			var quantity = molecule.b;
			return (quantity === 1) ? A2(
				elm$html$Html$span,
				_List_Nil,
				A2(elm$core$List$map, author$project$Molecule$MoleculeDisplay$moleculeTextHtml, atomList)) : A2(
				elm$html$Html$span,
				_List_Nil,
				_Utils_ap(
					_List_fromArray(
					...
					_Utils_ap(
						A2(elm$core$List$map, author$project$Molecule$MoleculeDisplay$moleculeTextHtml, atomList),
						_List_fromArray(
							[
								elm$html$Html$text(')'),
								A2(
...
var author$project$Molecule$MoleculeDisplay$moleculeText = function (molecule) {
	return mdgriffith$elm_ui$Element$html(
		author$project$Molecule$MoleculeDisplay$moleculeTextHtml(molecule));
};
var author$project$Molecule$MoleculeParser$cleanErrorsToString = function (deadends) {
	return 'error: ' + A2(
		elm$core$String$join,
		',',
		A2(
...
var author$project$Molecule$MoleculeParser$displayMoleculeClean = function (maybeMolecule) {
	if (maybeMolecule.$ === 'GoodMolecule') {
		var molecule = maybeMolecule.a;
		return author$project$Molecule$MoleculeDisplay$moleculeText(molecule);
	} else {
		var errors = maybeMolecule.a;
		return mdgriffith$elm_ui$Element$text(
			author$project$Molecule$MoleculeParser$cleanErrorsToString(errors));
	}
};
var author$project$Molecule$MoleculeParser$displayMolecule = function (molecule) {
	return author$project$Molecule$MoleculeParser$displayMoleculeClean(molecule);
};
var author$project$TableAndParserView$displayedCompound = function (model) {
	return A2(
		mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
		...
		author$project$Molecule$MoleculeParser$displayMolecule(model.moleculeData.inputMolecule));
};
var author$project$Molecule$MolarMass$addAll = function (list) {
	return A3(elm$core$List$foldr, elm$core$Basics$add, 0, list);
};
var elm$core$String$toFloat = _String_toFloat;
var author$project$Molecule$MolarMass$calculateMolarMass = function (molecule) {
	switch (molecule.$) {
		case 'Mono':
			var maybeAtom = molecule.a;
		...
		case 'Poly':
			...
			return A2(
				...
				A2(
					elm$core$Maybe$map,
					author$project$Molecule$MolarMass$addAll,
					elm_community$maybe_extra$Maybe$Extra$combine(
						A2(elm$core$List$map, author$project$Molecule$MolarMass$calculateMolarMass, maybeAtoms))));
		default:
			var amount = molecule.a;
			return elm$core$Maybe$Just(18.015 * amount);
	}
};
var author$project$Molecule$MolarMass$stringify = function (maybeMass) {
	return A2(
		elm$core$Maybe$withDefault,
		'0.000',
		A2(
...
var author$project$Molecule$MolarMass$molarMassString = function (maybeMolecule) {
	if (maybeMolecule.$ === 'GoodMolecule') {
		var molecule = maybeMolecule.a;
		return author$project$Molecule$MolarMass$stringify(
			author$project$Molecule$MolarMass$calculateMolarMass(molecule));
	} else {
		return '0.000';
	}
};
var author$project$TableAndParserView$appendTo = F2(
	function (s1, s2) {
		return _Utils_ap(s2, s1);
	});
var author$project$TableAndParserView$displayedMolarMass = function (model) {
	return A2(
		mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
		...
		mdgriffith$elm_ui$Element$text(
			A2(
				author$project$TableAndParserView$appendTo,
				' g/mol',
				author$project$Molecule$MolarMass$molarMassString(model.moleculeData.inputMolecule))));
};
var author$project$TableAndParserView$tableAndParserView = function (model) {
	return A2(
		mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				author$project$TableAndParser$PeriodicTable$periodicTable(model),
				author$project$TableAndParserView$compoundInput(model),
				author$project$TableAndParserView$displayedCompound(model),
				author$project$TableAndParserView$displayedMolarMass(model)
			]));
};
...
var author$project$View$htmlPage = function (pageElements) {
	return A3(
...
var author$project$View$view = function (model) {
	return author$project$View$htmlPage(
		function () {
			var _n0 = model.directory;
			if (_n0.$ === 'TableAndParserView') {
				return author$project$TableAndParserView$tableAndParserView(model);
			} else {
				return author$project$DetailedElementView$atomZoomView(model);
			}
		}());
};
