module Gen.Fetcher.OldWebsites exposing (call_, moduleName_, submit, values_)
...
{-| submit: 
    (Result Http.Error Route.OldWebsites.ActionData -> msg)
...
submit submitArg submitArg0 =
    Elm.apply
        (Elm.value
            { importFrom = [ "Fetcher", "OldWebsites" ]
            , name = "submit"
            , annotation =
                Just
                    (Type.function
